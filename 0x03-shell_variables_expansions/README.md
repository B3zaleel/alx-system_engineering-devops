...
+ [ ] 14\. Decimal to Hexadecimal<br/>_**100-decimal_to_hexadecimal**_ converts a number from base 10 to base 16. The number in base 10 is stored in the environment variable `DECIMAL`
...
+ [ ] 16\. The eggs of the brood need to be an odd number<br/>_**102-odd**_ prints every other line from the input, starting with the first line.
